...
public class DetalleServicioDAO {
    ...
    public List<DetalleServicioVista> buscarServiciosPorTipo(String tipoServicio) {
        List<DetalleServicioVista> lista = new ArrayList<>();
        ...
        try (Connection con = Conexion.getConexion();
            ...
            System.out.println("Error al buscar servicios por tipo: " + e.getMessage());
        }

        return lista;
    }
    
    public List<DetalleServicioVista> buscarServiciosPorFechas(Date desde, Date hasta) {
    List<DetalleServicioVista> lista = new ArrayList<>();
    ...
    String sql = "SELECT ds.idDetalleServ, u.dni, u.nombre, u.apellidos, s.tipo_serv AS servicio, ds.url_servicio, ds.fecha_serv " +
                 ...
                 "INNER JOIN usuarios u ON ds.dniFK = u.dni " +
                 "INNER JOIN servicios s ON ds.idServicioFK = s.idServicio " +
                 "WHERE ds.fecha_serv BETWEEN ? AND ?";
    ...
    try (Connection con = Conexion.getConexion();
        ...
        System.out.println("Error al buscar servicios por fechas: " + e.getMessage());
    }
